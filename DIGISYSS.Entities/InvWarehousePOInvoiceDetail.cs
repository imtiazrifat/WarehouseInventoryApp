...
namespace DIGISYSS.Entities
{
    ...
    public partial class InvWarehousePOInvoiceDetail
    {
        public int WarehousePOInvoiceDetailsId { get; set; }
        public Nullable<int> WarehousePOInvoiceMasterId { get; set; }
        public Nullable<int> Original_WarehousePODetailsId { get; set; }
