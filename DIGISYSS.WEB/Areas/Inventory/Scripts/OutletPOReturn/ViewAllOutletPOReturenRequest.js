var ViewAllOutletPOReturenRequestManager = {

    ViewAllOutletPOReturenRequestDataTable: function () {
        debugger;

        $('#myTableViewAllOutletPOReturenRequest').dataTable().fnDestroy();
        $('#myTableViewAllOutletPOReturenRequest').DataTable({
            "ajax": {
            ...
            "columns": [
                ...
                },
               {
                ...
                { "defaultContent": '<button class="btn btn-primary" id="btnViewAllOutletPOReturenRequestDetails" type="button">View Details</button>' },
            ],
            "columnDefs": [
    {
...
var ViewAllOutletPOReturenRequestHelper = {

    populateDataForViewAllOutletPOReturenRequestDetailsButton: function (aObj) {
        debugger;
